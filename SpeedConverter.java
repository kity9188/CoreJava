...
public class SpeedConverter {
	...
	public static void printConversion (double kilometersPerHour) {
		if (kilometersPerHour <0) {
			...
			System.out.println(kilometersPerHour + " km/hr = "+ converted + " mi/h");
		}
	}
...
/*------------------------------------------------------------------*/
//1 mile per hour is 1.609 km/hr
//Method Math.round to round the number of calculated miles per hour(double). The method round returns long.
//
...
//The result is rounded to an integer by adding 1/2, taking the floor of the result after
// adding 1/2, and typecasting the result to type long. The method returns the value of the
//argument rounded to the nearest int value.
/*------------------------------------------------------------------*/
